      ...
      <html lang="en-us">
        <head>
          ...
          <script dangerouslySetInnerHTML={{__html:
            `window.__env={ namespace: '${process.env.NAMESPACE}', githubClientID: '${process.env.GITHUB_CLIENT_ID}', repoName: '${process.env.REPO_NAME}', scheme: '${(process.env.SCHEME) ? process.env.SCHEME : ''}', baseDomain: '${process.env.BASE_DOMAIN}' };` }} />
        </head>
        <body>
