...
For simplicity in implementation, it was decided to build a proof of concept with support for JavaScript applications and test the feasibilty. 
\chapter{RESULTS}
...
\begin{enumerate}
	\item User opens the console by going to the link created by adminisrators
